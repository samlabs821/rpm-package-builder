...
Source1: https://github.com/vozlt/nginx-module-stream-sts/archive/v%{nginx_module_vozlt_stream_sts_version}/nginx-module-stream-sts-v%{nginx_module_vozlt_stream_sts_version}.tar.gz
Source2: %{url}/archive/v%{nginx_module_vozlt_sts_version}/nginx-module-sts-v%{nginx_module_vozlt_sts_version}.tar.gz
...
%{__install} -m 755 %{_builddir}/nginx-%{nginx_version}/objs/ngx_http_stream_server_traffic_status_module.so \
  %{buildroot}%{_libdir}/nginx/modules/ngx_http_stream_server_traffic_status_module.so
